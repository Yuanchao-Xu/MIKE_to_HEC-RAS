    ...
    with open(infile) as file:
        ...
        for line in file:
            ...
            if line.startswith('Branch'):
                ...
                if n_branch not in branch_of_all.keys():
                    branch_of_all[n_branch] = []
                if n_branch not in chainage_of_all.keys():
                    chainage_of_all[n_branch] = []
                ...
                chainage_of_all[n_branch].append(chainage)
            #append chainage to related branches
            ...
            if line.startswith('PROFILE'):
                ...
                branch_of_all[n_branch].append(prof)
                #append new list to related branch

                del prof
                #after appending the list, prof can be deleted
                ...
                '''
						...
						first one is for value, second directly inherited the object.
				'''
